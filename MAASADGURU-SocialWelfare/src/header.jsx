        ...
        <div style={styles.headerWrapper}>
            ...
            <div style={styles.mainHeader}>
                <NavLink to="/" style={styles.logoSection} onClick={handleMenuClick}>
                    <img src="/favicon.png" alt="Logo" style={styles.logoImg} className="logo-hover" />
            ...
            <nav style={styles.navBar}>
                ...
                <div style={styles.navList}>
                    ...
                    {localStorage.getItem('adminToken') ? (
                        <NavLink to="/admin/dashboard" style={({ isActive }) => isActive ? { ...styles.navLink, ...styles.activeLink } : styles.navLink} onClick={handleMenuClick}>Admin</NavLink>
                    ) : (
                        <NavLink to="/login" style={({ isActive }) => isActive ? { ...styles.navLink, ...styles.activeLink } : styles.navLink} onClick={handleMenuClick}>Login</NavLink>
                    )}
                    {isMobile && (
